...
const ProjectsLayout = () => {
    return (
        <>
            <Header />
            <section className="projects-layout pb-5 ">
                <Container fluid>
                    <Row>
                        <Col md="12">
                            <h1 className='mb-5 mt-5 heading-bold text-center'>
                        ...
                        <Row>
                            ...
                            <Col xs="12" md="6" lg="3">
                                <div className="project-card">
                                    ...
                                    <div className="text-place text-center">
                                        <h4 className='fs-5'>MCI is ready with New India </h4>
                                        <hr></hr>
                                        <h6 className='fs-6'>MCI India</h6>
                                        <p>Global marketing engagement agency </p>
                                        <p>Showcase India in a new light as an emerging & vibrant meeting & expo destination  </p>
                                        <p>
                                            Position MCI India as a global company with local know-how
                                        </p>
                                        <Link className='button-primary btn btn-secondary'>Read More</Link>
                                    </div>
                                </div>
